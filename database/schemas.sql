...
CREATE TABLE IF NOT EXISTS FACT_ORDER (
		...
		EMP_PURCHASER_ID     INT NOT NULL,
		PRODUCT_ID           INT NOT NULL,
		DATE_ID              INT NOT NULL,
		QUANTITY             INT NOT NULL,
		TOTAL_AMOUNT         DECIMAL NOT NULL     
);
ALTER TABLE FACT_ORDER ADD CONSTRAINT  FACT_ORDER_SUPPLIER_FK FOREIGN KEY(SUPPLIER_ID) REFERENCES DIM_SUPPLIER(ID) ;
ALTER TABLE FACT_ORDER ADD CONSTRAINT  FACT_ORDER_EMP_PURCHASER_FK FOREIGN KEY(EMP_PURCHASER_ID) REFERENCES DIM_EMPLOYEE_PURCHASER(ID) ;
ALTER TABLE FACT_ORDER ADD CONSTRAINT  FACT_ORDER_PRODUCT_FK FOREIGN KEY(PRODUCT_ID) REFERENCES DIM_PRODUCT(ID) ;
ALTER TABLE FACT_ORDER ADD CONSTRAINT  FACT_ORDER_DATE_FK FOREIGN KEY(DATE_ID) REFERENCES DIM_DATE(ID) ;
